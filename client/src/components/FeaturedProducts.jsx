...
const FeaturedProducts = ({ fetchFeaturedProducts }) => {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            else if (window.innerWidth < 1260) setItemsPerPage(3)
    ...
    const isEndDisabled = currentIndex >= fetchFeaturedProducts.length - itemsPerPage
                ...
                <div className="relative">
                    <div className="overflow-hidden">
                        ...
                        >
                            ...
                            {fetchFeaturedProducts?.map((product) => (
                                <div key={product._id} className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex-shrink-0 px-2">
                                    <div className="bg-gray-800 bg-opacity-10 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full transition-all
                            duration-300 hover:shadow-xl border border-emerald-500/30">
                                        <div className="overflow-hidden">
                                            <img
                                                src={product.image}
                                                alt={product.name}
                                        ...
                                        <div className="p-4">
                                            ...
                                            <button
                                                ...
                                                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-2 px-4 rounded transition-colors
                                                duration-300 flex item-center justify-center"
                                            >
